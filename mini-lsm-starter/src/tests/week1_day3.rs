...
fn test_block_seek_key() {
    ...
    for offset in 1..=5 {
        for i in 0..num_of_keys() {
            ...
            println!(
                "calling seek_to_key, offset {:?} {:?}",
                offset,
                as_bytes(
                    KeySlice::for_testing_from_slice_no_ts(
        ...
        println!(
            "calling seek_to_key {:?}",
            as_bytes(KeySlice::for_testing_from_slice_no_ts(b"k").for_testing_key_ref())
        );
